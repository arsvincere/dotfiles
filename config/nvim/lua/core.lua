...
-- opt.foldmethod = 'manual'        -- Группировка вручную по zf
opt.foldmethod = 'marker'        -- Группировка вручную по zf

-- Автосохранение фолдинга при потере фокуса
-- autocmd('BufLeave', { pattern = '*.py', command = 'mkview' })
-- autocmd('BufLeave', { pattern = '*.pyw', command = 'mkview' })
-- autocmd('BufLeave', { pattern = '*.cpp', command = 'mkview' })
-- autocmd('BufLeave', { pattern = '*.h', command = 'mkview' })
-- autocmd('BufLeave', { pattern = '*.lua', command = 'mkview' })

-- Автозагрузка фолдинга
autocmd('BufReadPost', { pattern = '*.py', command = 'loadview' })
autocmd('BufReadPost', { pattern = '*.pyw', command = 'loadview' })
autocmd('BufReadPost', { pattern = '*.cpp', command = 'loadview' })
autocmd('BufReadPost', { pattern = '*.h', command = 'loadview' })
autocmd('BufReadPost', { pattern = '*.lua', command = 'loadview' })
autocmd('BufReadPost', { pattern = '*.md', command = 'loadview' })
